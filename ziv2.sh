...
wget https://github.com/Dimank_cyber/Zivpn/releases/download/Zivpn_1.4.9/Zivpn-linux-amd64 -O /usr/local/bin/zivpn 1> /dev/null 2> /dev/null
chmod +x /usr/local/bin/zivpn
mkdir /etc/zivpn 1> /dev/null 2> /dev/null
wget https://raw.githubusercontent.com/Dimank_cyber/Zivpn/main/config.json -O /etc/zivpn/config.json 1> /dev/null 2> /dev/null
